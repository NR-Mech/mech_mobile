...
import 'package:mech/common_widget/menu_row.dart';
import 'package:mech/screen/home/home_tab_screen.dart';
...
class _MainTabScreenState extends State<MainTabScreen>
  ...
  List menuArr = [
    {'name': 'Meus Atendimentos', 'icon': 'assets/img/my_apo.png', 'action': '1'},
    {
      'name': 'Novo Atendimento',
      'icon': 'assets/img/new_app.png',
      'action': '2'
    },
    {'name': 'Históricos', 'icon': 'assets/img/recode.png', 'action': '3'},
    ...
    {'name': 'Ajuda', 'icon': 'assets/img/help.png', 'action': '6'},
    {'name': 'Sair', 'icon': 'assets/img/logout.png', 'action': '7'}
  ];
